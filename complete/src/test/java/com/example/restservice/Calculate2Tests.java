...
public class Calculate2Tests {
    ...
    public void testMultiply() {
        assertEquals(40, siUnitSingleton.calculate2("5*8"),      
        "5*8 should be 40");          
    }
    ...
    public void testMultiplyParenthesis2() {
        assertEquals(240, siUnitSingleton.calculate2("(5*8)*(2*3)"),      
    ...
    public void testMultiplyAndDivision() {
        assertEquals(10, siUnitSingleton.calculate2("(5*8)/(2*2)"),      
    ...
    public void testMultiplyAndDivision2() {
        assertEquals(24, siUnitSingleton.calculate2("(2*8/(1*4))/(1*2)*(3*4)"),      
